...
function Navbar() {
  ...
  return (
    <div className="bg-gray-200 py-2">
      <nav
        className="dark:bg-gray-900 sticky w-full z-20 top-0 start-0 border-b border-gray-200
      ...
      >
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src={Logo} className="h-8" alt="MyLogo" />
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center p-2 w-10
                         h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 
